...
import { DEMO_PROMPT, DEMO_TOPIC } from "@/lib/demo-content";
...
const defaultPrompt = DEMO_PROMPT;
...
export default function Home() {
  ...
  return <main className="student-workspace"><div className="student-shell">
    ...
    {result && <section className="orchestration-result">
      ...
      <section className="result-section"><TopicWorkspace topic={prompt === DEMO_PROMPT ? DEMO_TOPIC : prompt} sources={result.sources}/></section>
